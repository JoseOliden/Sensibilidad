...
formula_str = "(Cn*exp(-lamb*td)*lamb*tr/((1-exp(-lamb*ti))*(1-exp(-lamb*tr))*w*tv*Aesp_Au))*(1/k0)*(e_Au/e)*((f + (15.283/(5.65*exp(-alfa))**alfa + 0.429/((2*alfa+1)*0.55**alfa)))/(f + (Q0-0.429)/(Er*exp(-rho*alfa))**alfa + 0.429/((2*alfa+1)*0.55**alfa)))"
